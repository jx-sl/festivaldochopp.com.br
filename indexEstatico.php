                ...
                <div class="col-xs-8">
                  ...
                  <div class="row">
                    <div class="col-xs-6">
                      <div class="row">
                        <div class="col-xs-6">
                          <img class="image-border" src="images/noticia-capa-7.jpg" width="150" height="150">
                        </div>
                        <div class="col-xs-6">
                          <h5 class="news-tittle">Promotoria de Feliz mantém proibição para entrada de menores</h5>
                          <p class="news-text">Esse ano, a entrada de menores de 18 anos está proibida no Festival Nacional do Chopp. A Socef, através de Assessoria...
                          <a href="noticias-7.php">LEIA MAIS</a></p>
                        </div>
                      </div>
                    </div> <!-- end col-xs-6 -->
                    <div class="col-xs-6">
                      <div class="row">
                        <div class="col-xs-6">
                          <img class="image-border" src="images/noticia-capa-6.jpg" width="150" height="150">
                        </div>
                        <div class="col-xs-6">
                          <h5 class="news-tittle">Comissão Organizadora visita Câmara de Vereadores</h5>
                          <p class="news-text">A Comissão Organizadora do 47º Festival Nacional do Chopp visitou ontem, segunda-feira, a Câmara de Vereadores de Feliz...
                          <a href="noticias-6.php">LEIA MAIS</a></p>
                        </div>
                      </div>
                    </div> <!-- end col-xs-6 -->
                  </div> <!-- end row -->
                  ...
                  <div class="row">
                    <div class="col-xs-3">
                      <a href="galeria.php">
                        <img class="image-border" src="images/galeria-1.jpg" width="150" height="115">
                      </a>
                      <h6>46º Festival - 2º Noite</h6>
                    </div>
                    <div class="col-xs-3">
                      <a href="galeria.php">
                        <img class="image-border" src="images/galeria-2.jpg" width="150" height="115">
                      </a>
                      <h6>46º Festival - 1ª Noite</h6>
                    </div>
                    <div class="col-xs-3">
                      <a href="galeria.php">
                        <img class="image-border" src="images/galeria-3.jpg" width="150" height="115">
                      </a>
                      <h6>Baile Lançamento 2013</h6>
                    </div>
                    <div class="col-xs-3">
                      <a href="galeria.php">
                        <img class="image-border" src="images/galeria-4.jpg" width="150" height="115">
                      </a>
                      <h6>Galeria de Rainhas</h6>
                    </div>
                  </div>
