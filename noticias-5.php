            ...
            <div class="col-xs-12">
              ...
              <div class="row noticias">
                <div class="col-xs-10 col-xs-offset-1">
                  ...
                  <div class="row">
                    <div class="col-xs-4">
                      <img src="images/noticia-5.jpg" width="270" height="180" class="image-border">
                    </div>
                    <div class="col-xs-8">
                      <p>A Comissão Organizadora, que está ultimando a entrega dos convites para a abertura oficial do evento de 2014, visitou na manhã dessa quinta-feira o Prefeito Municipal de Feliz, Albano Kunrath.</p>
                    </div>
                  </div>
