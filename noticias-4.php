            ...
            <div class="col-xs-12">
              ...
              <div class="row noticias">
                <div class="col-xs-10 col-xs-offset-1">
                  <h4><span>19/03/2014 - </span>Soberanas entregam convite ao Governador</h4>
                  <div class="row">
                    <div class="col-xs-4">
                      <img src="images/noticia-4.jpg" width="270" height="180" class="image-border">
                    </div>
                    <div class="col-xs-8">
                      <p>A Soberanas de Feliz, juntamente com membros da Comissão Organizadora do 47º Festival Nacional do Chopp, estiveram em Porto Alegre no dia 18 de março para entregar um convite ao Governador do Estado, Tarso Genro.</p>
                    </div>
                  </div>
